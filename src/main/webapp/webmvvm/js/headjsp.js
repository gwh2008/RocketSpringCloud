...
ctxStatic="../../../";
var headsjs='<script src="'+ctxStatic+'libs/jquery.min.js"></script>';
headsjs+='<script src="'+ctxStatic+'plugins/jqgrid/jquery.jqGrid.min.js"></script>';
headsjs+='<script src="'+ctxStatic+'libs/vue.min.js"></script>';
headsjs+='<script src="'+ctxStatic+'libs/router.js"></script>';
headsjs+='<script src="'+ctxStatic+'libs/app.js"></script>';
headsjs+='<script src="'+ctxStatic+'plugins/layer/layer.js"></script>';
headsjs+='<script src="'+ctxStatic+'js/common.js"></script>';
headsjs+='<script src="'+ctxStatic+'js/select.js"></script>';
document.write(heads); 
document.write(headsjs);