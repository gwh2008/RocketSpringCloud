...
<head>
	...
	<script type="text/javascript">
        ...
        function select(){
			...
			var moduleName =  $("#contentTable tbody tr td input.i-checks:checkbox:checked").attr("moduleName");
			var moduleDescribe =  $("#contentTable tbody tr td input.i-checks:checkbox:checked").attr("moduleDescribe");

			var obj= '"id":id';
			if(moduleName==undefined) moduleName="";
				obj+=',"moduleName":"'+moduleName+'"';
			if(moduleDescribe==undefined) moduleDescribe="";
				obj+=',"moduleDescribe":"'+moduleDescribe+'"';
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  class="sort-column moduleName">模块名称（关键字）</th>
				<th  class="sort-column moduleDescribe">模块功能描述</th>
				<th>操作</th>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="gaowh">
			<tr>
				...
				class="i-checks"></td>
				<td><a  href="#" onclick="openDialogView('查看模块管理', '${ctx}/gaowh/gaowh/form?id=${gaowh.id}','800px', '500px')">
					${gaowh.moduleName}
				</a></td>
				<td>
				...
				<td>
					<!--shiro:hasPermission name="gaowh:gaowh:view"-->
						<a href="#" onclick="openDialogView('查看模块管理', '${ctx}/gaowh/gaowh/form?id=${gaowh.id}','800px', '500px')" class="btn btn-info btn-sm" ><i class="fa fa-search-plus"></i> 查看</a>
					<!--/shiro:hasPermission-->
				</td>
			</tr>
		</c:forEach>
