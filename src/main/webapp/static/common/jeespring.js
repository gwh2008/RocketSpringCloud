/*! * * Copyright &copy; 2015-2020 <a href="https://github.com/gaowenhui/RocketSpringCloud">JeeSpring</a> All rights reserved.. *  * 通用公共方法 * @author gaowh 286899139@qq.com * @version 2018-10-11 */
...
function printGods(){
    ...
    console.log(
        ...
        "                  谈笑风生社会圈，享天福天下归心。                \n" +
        "\n" +
        "          RocketSpringCloud是分布式微服务集群开源框架，使用前端HTML或后端模板引擎+mvvm+spring mvc+spring boot+spring cloud、mybatis、alibaba dubbo 分布式、\n" +
