...
public class LoginController extends AbstractBaseController {
	 ...
	 * @throws IOException 
	 */
	@RequestMapping(value = "${adminPath}/login/2", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "${adminPath}/loginBase", method = RequestMethod.GET)
	public String loginBase(HttpServletRequest request, HttpServletResponse response, Model model) throws IOException {
		Principal principal = UserUtils.getPrincipal();
		...
		return "modules/sys/sysLoginBase";
	}
